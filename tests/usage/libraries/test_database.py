...
def test__create_schema() -> None:
    ...
    exp_calls = [
        ...
        call.execute("CREATE INDEX IF NOT EXISTS ix_sensors_house_id ON sensors(house_id)"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_samples_sensor_id_measured_at ON samples(sensor_id, measured_at)"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_water_points_feed_id_measured_at ON water_points(feed_id, measured_at)"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_enphase_points_feed_id_span_measured_at ON enphase_points(feed_id, span_minutes, measured_at)"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_api_calls_key_hash_called_at ON api_calls(key_hash, called_at)"),
    ]
    assert connection.mock_calls == exp_calls
    reset_mocks()
...
def test__migrate() -> None:
    ...
    connection.execute.return_value.fetchone.side_effect = [None] * 26
    ...
    exp_calls = [
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE registers ALTER COLUMN initial_value TYPE NUMERIC(12,3)"),
        call.execute("ALTER TABLE reading_values ALTER COLUMN value TYPE NUMERIC(12,3)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE meter_orders ALTER COLUMN position DROP NOT NULL"),
        call.execute("ALTER TABLE meter_orders ALTER COLUMN position DROP DEFAULT"),
        call.execute("ALTER TABLE meter_orders ADD COLUMN IF NOT EXISTS color TEXT NOT NULL DEFAULT ''"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS timezone TEXT NOT NULL DEFAULT 'Europe/Paris'"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
            (8, 'house time zones'),
        ),
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS ingest_token_hash TEXT NOT NULL DEFAULT ''"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("CREATE TABLE IF NOT EXISTS sensor_alerts (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, user_id BIGINT NOT NULL REFERENCES users(id) ON DELETE CASCADE, house_id BIGINT NOT NULL REFERENCES houses(id) ON DELETE CASCADE, enabled BOOLEAN NOT NULL DEFAULT false, created_at TIMESTAMPTZ NOT NULL DEFAULT now(), UNIQUE(user_id, house_id))"),
        call.execute("ALTER TABLE sensors ADD COLUMN IF NOT EXISTS threshold_min NUMERIC(8,2)"),
        call.execute("ALTER TABLE sensors ADD COLUMN IF NOT EXISTS threshold_max NUMERIC(8,2)"),
        call.execute("ALTER TABLE sensors ADD COLUMN IF NOT EXISTS alert_state TEXT NOT NULL DEFAULT ''"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute("ALTER TABLE sensors ADD CONSTRAINT sensors_threshold_range CHECK (threshold_min IS NULL OR threshold_max IS NULL OR threshold_min < threshold_max)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE sensors ADD COLUMN IF NOT EXISTS battery INTEGER"),
        call.execute("ALTER TABLE sensors ADD COLUMN IF NOT EXISTS battery_at TIMESTAMPTZ"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("CREATE TABLE IF NOT EXISTS water_feeds (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, house_id BIGINT NOT NULL REFERENCES houses(id) ON DELETE CASCADE, hostname TEXT NOT NULL DEFAULT 'eyeonwater.com', username_sealed TEXT NOT NULL, username_hash TEXT NOT NULL, password_sealed TEXT NOT NULL, meter_uuid_sealed TEXT NOT NULL, meter_uuid_hash TEXT NOT NULL, export_unit TEXT NOT NULL DEFAULT 'Cubic Meters', active BOOLEAN NOT NULL DEFAULT true, claimed_until TIMESTAMPTZ, last_sync_at TIMESTAMPTZ, last_point_at TIMESTAMPTZ, last_error TEXT NOT NULL DEFAULT '', backfill_from DATE, backfill_done BOOLEAN NOT NULL DEFAULT false, empty_chunks INTEGER NOT NULL DEFAULT 0, created_at TIMESTAMPTZ NOT NULL DEFAULT now(), UNIQUE(house_id, meter_uuid_hash))"),
        call.execute("CREATE TABLE IF NOT EXISTS water_points (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, feed_id BIGINT NOT NULL REFERENCES water_feeds(id) ON DELETE CASCADE, measured_at TIMESTAMPTZ NOT NULL, volume NUMERIC(12,6) NOT NULL, reading NUMERIC(14,4), method TEXT NOT NULL DEFAULT '', UNIQUE(feed_id, measured_at))"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_water_points_feed_id_measured_at ON water_points(feed_id, measured_at)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS shows_sensors BOOLEAN NOT NULL DEFAULT false"),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS shows_water BOOLEAN NOT NULL DEFAULT false"),
        call.execute("UPDATE houses SET shows_sensors = EXISTS (SELECT 1 FROM sensors WHERE sensors.house_id = houses.id), shows_water = EXISTS (SELECT 1 FROM water_feeds WHERE water_feeds.house_id = houses.id)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE water_feeds ALTER COLUMN export_unit SET DEFAULT 'Gallons'"),
        call.execute("UPDATE water_feeds SET export_unit = 'Gallons' WHERE export_unit = 'Cubic Meters'"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("CREATE TABLE IF NOT EXISTS water_alerts (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, user_id BIGINT NOT NULL REFERENCES users(id) ON DELETE CASCADE, house_id BIGINT NOT NULL REFERENCES houses(id) ON DELETE CASCADE, enabled BOOLEAN NOT NULL DEFAULT false, created_at TIMESTAMPTZ NOT NULL DEFAULT now(), UNIQUE(user_id, house_id))"),
        call.execute("ALTER TABLE water_feeds ADD COLUMN IF NOT EXISTS leaking BOOLEAN NOT NULL DEFAULT false"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS shows_power BOOLEAN NOT NULL DEFAULT false"),
        call.execute("CREATE TABLE IF NOT EXISTS enphase_feeds (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, house_id BIGINT NOT NULL REFERENCES houses(id) ON DELETE CASCADE, client_id_sealed TEXT NOT NULL, client_secret_sealed TEXT NOT NULL, api_key_sealed TEXT NOT NULL, system_id_sealed TEXT NOT NULL, system_id_hash TEXT NOT NULL, access_token_sealed TEXT NOT NULL DEFAULT '', refresh_token_sealed TEXT NOT NULL DEFAULT '', token_expires_at TIMESTAMPTZ, active BOOLEAN NOT NULL DEFAULT true, claimed_until TIMESTAMPTZ, last_sync_at TIMESTAMPTZ, last_point_at TIMESTAMPTZ, last_error TEXT NOT NULL DEFAULT '', backfill_from DATE, backfill_done BOOLEAN NOT NULL DEFAULT false, fine_from DATE, fine_done BOOLEAN NOT NULL DEFAULT false, calls_used INTEGER NOT NULL DEFAULT 0, calls_budget INTEGER NOT NULL DEFAULT 1000, calls_month DATE, created_at TIMESTAMPTZ NOT NULL DEFAULT now(), UNIQUE(house_id, system_id_hash))"),
        call.execute("CREATE TABLE IF NOT EXISTS enphase_points (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, feed_id BIGINT NOT NULL REFERENCES enphase_feeds(id) ON DELETE CASCADE, measured_at TIMESTAMPTZ NOT NULL, span_minutes INTEGER NOT NULL DEFAULT 15, production NUMERIC(14,6), consumption NUMERIC(14,6), battery_level NUMERIC(5,2), UNIQUE(feed_id, measured_at, span_minutes))"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_enphase_points_feed_id_span_measured_at ON enphase_points(feed_id, span_minutes, measured_at)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("CREATE TABLE IF NOT EXISTS api_calls (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, key_hash TEXT NOT NULL, called_at TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp())"),
        call.execute("CREATE INDEX IF NOT EXISTS ix_api_calls_key_hash_called_at ON api_calls(key_hash, called_at)"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE enphase_feeds ADD COLUMN IF NOT EXISTS source TEXT NOT NULL DEFAULT 'cloud'"),
        call.execute("CREATE TABLE IF NOT EXISTS enphase_live (house_id BIGINT PRIMARY KEY REFERENCES houses(id) ON DELETE CASCADE, measured_at TIMESTAMPTZ NOT NULL, production_power NUMERIC(12,3), consumption_power NUMERIC(12,3), battery_level NUMERIC(5,2), production_lifetime NUMERIC(16,3), consumption_lifetime NUMERIC(16,3), updated_at TIMESTAMPTZ NOT NULL DEFAULT now())"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute(
            "CREATE TABLE IF NOT EXISTS switchbot_feeds (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, "
            "house_id BIGINT NOT NULL REFERENCES houses(id) ON DELETE CASCADE, token_sealed TEXT NOT NULL, "
            "token_hash TEXT NOT NULL, secret_sealed TEXT NOT NULL, hub_ids_sealed TEXT NOT NULL DEFAULT '', "
            "active BOOLEAN NOT NULL DEFAULT true, claimed_until TIMESTAMPTZ, last_sync_at TIMESTAMPTZ, "
            "last_point_at TIMESTAMPTZ, last_error TEXT NOT NULL DEFAULT '', "
            "created_at TIMESTAMPTZ NOT NULL DEFAULT now(), UNIQUE(house_id, token_hash))",
        ),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
        ...
        call.execute().fetchone(),
        call.execute("ALTER TABLE houses ADD COLUMN IF NOT EXISTS shows_switchbot BOOLEAN NOT NULL DEFAULT false"),
        call.execute(
            "UPDATE houses SET shows_switchbot = true "
            "WHERE id IN (SELECT house_id FROM switchbot_feeds WHERE active)",
        ),
        call.execute("UPDATE houses SET shows_sensors = false WHERE shows_sensors AND ingest_token_hash = ''"),
        call.execute("ALTER TABLE switchbot_feeds ADD COLUMN IF NOT EXISTS event_token_sealed TEXT NOT NULL DEFAULT ''"),
        call.execute("ALTER TABLE switchbot_feeds ADD COLUMN IF NOT EXISTS event_token_hash TEXT NOT NULL DEFAULT ''"),
        call.execute("ALTER TABLE switchbot_feeds ADD COLUMN IF NOT EXISTS webhook_at TIMESTAMPTZ"),
        call.execute("ALTER TABLE switchbot_feeds ADD COLUMN IF NOT EXISTS webhook_error TEXT NOT NULL DEFAULT ''"),
        call.execute("ALTER TABLE switchbot_feeds ADD COLUMN IF NOT EXISTS last_event_at TIMESTAMPTZ"),
        call.execute(
            "INSERT INTO schema_migrations(version, name) VALUES (%s, %s)",
    ...
    connection.execute.return_value.fetchone.side_effect = [{"?column?": 1}] * 26
    result = tested._migrate(connection)
    assert result is None
    exp_calls = [
        call.execute(
